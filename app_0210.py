...
def resources():
    ...
    try:
        ...
        print("📡 user-info status:", user_resp.status_code)
        print("📡 user-info text:", user_resp.text)

        if user_resp.ok and "user" in user_resp.json():
        ...
        print("✅ Rendering resources.html with:")
        print("   username:", user.get("username"))
        print("   usertype:", user.get("usertype"))
...
def submit_nrm_enquiries():
    ...
    try:
        ...
        # Send enquiry to AWS Step Functions
        payload = {
            "name": name,
            "email": email,
            "phone": phone,
        ...
        try:
            ...
            print(f"⚠ Step Functions execution failed: {sf_err}")
